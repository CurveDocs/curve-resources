...
Благодаря механизму усиления (boosting) Rewards Gauge, доходность вознаграждений (Rewards APR) будет отображаться как диапазон на основе коэффициента усиления пользователя. Узнайте больше об усилении [здесь](../reward-gauges/boosting-your-crv-rewards.md).
