...
- **Вестинг/Разблокировано** — Вестинг означает, что токены заблокированы на определенный период времени. Разблокированные токены доступны после окончания периода вестинга.
...
- **Всего предложения** — Количество выпущенных CRV, которые в данный момент существуют, включая предмайненные CRV, заблокированные в контрактах вестинга.
