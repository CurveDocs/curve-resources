...
crvUSD выпускается только на Ethereum и использует высококачественные активы с глубокой ликвидностью для снижения риска плохого долга. Благодаря этим мерам предосторожности, **плохой долг не ожидается в системе выпуска crvUSD**. Однако плохой долг может и возникать на отдельных рынках Curve Lending, так как они не требуют разрешения для создания, но они не влияют на целостность стейблкоина crvUSD.
