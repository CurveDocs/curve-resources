...
*This guide demonstrates the deposit and staking process using the [TriCRV pool](https://curve.finance/dex/ethereum/pools/factory-tricrypto-4/deposit), to show you how to deposit and start earning rewards.*
...
Visit the deposit page ([https://curve.finance/dex/ethereum/pools/factory-tricrypto-4/deposit](https://curve.finance/dex/ethereum/pools/factory-tricrypto-4/deposit)). You will need at least one of the three tokens in the pool to deposit. The TriCRV pool consists of CRV, crvUSD, and ETH.
